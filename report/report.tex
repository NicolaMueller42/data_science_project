...
\end{itemize}
\color{black}
\nm{Related work for business stuff is still missing! Also adjust motivation for embeddings?}
...
\section{Results}
\nm{Move current clustering results to appendix and rewrite section for the new results, keep location recommendation results as they are?}
\begin{figure}[H]
    \centering
