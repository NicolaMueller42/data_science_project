...
from clustering_kpca import fit_pca, fit_kernel_pca, cluster_data, predict_cluster, visualize_clustering, visualize_tsne, print_clusters
...
clustering = cluster_data(data=train_embeddings, kpca=pca, n_clusters=n_clusters, n_init=50,
